...
import { test, registerUser, loginUser, getProfile, getLogout, fetchUsers, deleteUser, editUser, createNews, fetchNews, fetchOneNew, upload } from '../controllers/clubControllers.js'
